...
/* package pProjeto-0.1.0.0 */
#ifndef VERSION_pProjeto
#define VERSION_pProjeto "0.1.0.0"
#endif /* VERSION_pProjeto */
#ifndef MIN_VERSION_pProjeto
#define MIN_VERSION_pProjeto(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pProjeto */
...
#define CURRENT_COMPONENT_ID "pProjeto-0.1.0.0-E1BXcfNXoURIkSBwTLBui5-pProjeto"
