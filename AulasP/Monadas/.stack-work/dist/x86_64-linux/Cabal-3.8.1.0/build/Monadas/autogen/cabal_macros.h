...
/* package Monadas-0.1.0.0 */
#ifndef VERSION_Monadas
#define VERSION_Monadas "0.1.0.0"
#endif /* VERSION_Monadas */
#ifndef MIN_VERSION_Monadas
#define MIN_VERSION_Monadas(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Monadas */
...
#define CURRENT_COMPONENT_ID "Monadas-0.1.0.0-39THneYmiLZBYuyMfVXCwL-Monadas"
